# Life Dashboard Project - Complete SDLC Plan Generation Prompt

Last Updated: 2025-04-18 08:37:45 PM PDT
Author: Kxvin1

## Overview

This prompt is designed to guide an AI in generating a comprehensive Software Development Life Cycle (SDLC) plan proposal for the Life Dashboard project. The goal is to produce actionable steps, foundational documentation, system diagrams (ASCII), project scaffolding, and core functional code examples with clear setup instructions. The generated code should serve as a strong starting point.
...
## Required Components in Generated Plan
...
This project is designed for a solo developer learning modern web development technologies. The implementation should prioritize simplicity and maintainability while providing room for future enhancements and scaling. The focus is on building a solid foundation for the core Life Dashboard modules and integrating the specified technologies effectively.
