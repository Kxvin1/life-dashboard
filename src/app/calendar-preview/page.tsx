              ...
              >
                ...
                <div className="space-y-1">
                  {events.slice(0, 3).map((event) => (
                    <div
                      key={event.id}
                      className={`text-xs px-2 py-1 rounded text-white truncate ${event.color} hover:opacity-80 cursor-pointer relative group`}
                  ...
                  {events.length > 3 && (
                    <div className="px-2 py-1 text-xs rounded cursor-pointer text-muted-foreground bg-secondary/50 hover:bg-secondary/70">
